## TWRP Device Tree for the Galaxy J5 2015 (j5lte)
...
2. Clone this repository to `device/samsung/j5lte`
```
git clone https://github.com/prototype74/android_device_samsung_j5lte.git -b android-8.1-sdc2 device/samsung/j5lte
```

3. Build the recovery image
```bash
export ALLOW_MISSING_DEPENDENCIES=true; . build/envsetup.sh; lunch omni_j5lte-eng; mka recoveryimage
```
